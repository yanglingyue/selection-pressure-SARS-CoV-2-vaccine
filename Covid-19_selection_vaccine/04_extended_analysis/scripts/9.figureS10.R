...
my1 <- which(dat1$month=="2022-01"|dat1$month=="2022-02"|
...
outpath0 <-  "04_extended_analysis/plot_output/Figure_S10"
dir.create(outpath0)


outpath1 <-  paste0(outpath0,"/","all_vaccine_202201_202209_low_VE")
dir.create(outpath1)
...
ggsave(p,filename = file.path(outpath0
                              ,"figS10-202003-202110--VE-jama.pdf"),
       width = 18,height =6.2)
