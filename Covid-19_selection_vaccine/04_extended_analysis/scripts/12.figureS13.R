...
outpath0 <-  "04_extended_analysis/plot_output/Figure_S13"
dir.create(outpath0)
outpath <-  paste0(outpath0,"/","all_vaccine_202003_202110_remove")
dir.create(outpath)
outpath1 <-  paste0(outpath,"/","vero_result",sep="")
dir.create(outpath1)
outpath2 <-  paste0(outpath0,"/","natural_immunity_202003_202110_remove")
dir.create(outpath2)
...
ggsave(p,filename = file.path(root_path,"/",outpath0,"/","figure_S13.pdf"),
