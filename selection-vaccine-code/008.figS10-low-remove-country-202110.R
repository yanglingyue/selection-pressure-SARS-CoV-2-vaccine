...
x1 <- which(dat1$country=="Puerto Rico"|dat1$country=="Canary Islands"|dat1$country=="French Guiana"|
...
outpath <-  "02_model-output/all_vaccine_202003_202110_remove_countries"
dir.create(outpath)
...
outpath2 <-  "02_model-output/natural_immunity_202003_202110_remove_countries"
dir.create(outpath2)
...
ggsave(p,filename = file.path("C:/Users/Yanglingyue/Desktop/mutation_dnds/low_coverage_sequence/selection-vaccine-code-v8/03_fig-main"
                              ,"figS10-low-all-vaccine-remove-countries-202003-20210.pdf"),
